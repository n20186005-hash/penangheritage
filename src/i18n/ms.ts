...
export const content: PageContent = {
  ...
  footer: {
    brand: 'JEJAK WARISAN',
    note: 'Nota: Laman ini ialah panduan tidak rasmi dan tidak berafiliasi dengan UNESCO, kerajaan tempatan atau mana-mana tarikan yang disenaraikan.',
    copyright: '© George Town · Jalan perlahan, lihat lebih banyak.'
  }
};
