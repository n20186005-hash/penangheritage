...
export const content: PageContent = {
  ...
  footer: {
    ...
    note: 'Note: This site is an unofficial guide and is not affiliated with UNESCO, local government or any of the listed attractions.',
    copyright: '© George Town · Walk slowly, see more.'
  }
};
